...
def get_blob(cloud_path, bucket_name):
  client = _get_client()
  bucket = client.get_bucket(bucket_name)
  return bucket.blob(str(cloud_path))

def file_exists(cloud_path, bucket_name):
...
def list_files(bucket_name, directory=None):
  client = _get_client()
  bucket = client.get_bucket(bucket_name)
...
def download_json(cloud_path, bucket_name):
  client = _get_client()
  bucket = client.get_bucket(bucket_name)
  blob = bucket.blob(str(cloud_path))
